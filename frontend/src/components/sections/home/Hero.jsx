...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 bg-[#fafafa] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        {/* Left Content */}
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-[0.2em] mb-6">
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <Link
              to="/contact"
              className="bg-blue-600 text-white px-10 py-5 rounded-full font-bold flex items-center gap-3 hover:bg-slate-900 transition-all duration-300 200"
            >
        ...
        <div className="relative">
          <div className="w-full aspect-square bg-white rounded-[4rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] border border-slate-100 relative overflow-hidden p-8">
            {/* Abstract Data Visualization */}
            <div className="h-full w-full flex flex-col gap-6">
              {/* Revenue Card */}
              <div className="bg-slate-900 text-white p-8 rounded-3xl transform hover:scale-[1.02] transition-transform cursor-default">
              ...
              <div className="grid grid-cols-2 gap-6 h-full">
                <div className="bg-blue-50 p-2 rounded-[2.5rem] flex flex-col justify-center items-center text-center">
                ...
                <div className="bg-slate-50 p-2 rounded-[2.5rem] flex flex-col justify-center items-center text-center border border-slate-200/50">
          ...
          {/* Floating Tag */}
          <div className="absolute -top-6 -right-6 bg-white shadow-2xl p-4 rounded-2xl flex items-center gap-3 animate-bounce-slow">
